...
struct omap_volt_data omap446x_vdd_mpu_volt_data[] = {
	...
	// SpeedBin override value pulled from Tate device w/ efuse entry enabled.
	VOLT_DATA_DEFINE_NVALUE(OMAP4460_VDD_MPU_OPPNITROSB_UV, 0, OMAP44XX_CONTROL_FUSE_MPU_OPPNITROSB, 0xfa, 0x27, OMAP_ABB_FAST_OPP, 12316894),
	VOLT_DATA_DEFINE(0, 0, 0, 0, 0, 0),
};
...
static struct omap_opp_def __initdata omap446x_opp_def_list[] = {
	...
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1600000000, OMAP4460_VDD_MPU_OPPNITROSB_UV),
	OPP_INITIALIZER("mpu", "virt_dpll_mpu_ck", "mpu", false, 1728000000, OMAP4460_VDD_MPU_OPPNITROSB_UV),
	/* L3 OPP1 - OPP50 */
...
int __init omap4_opp_init(void)
{
	...
	if (omap4_has_mpu_1_5ghz() && trimmed)
		...
		omap4_opp_enable("mpu", 1728000000);
